...
def default_action():
    ...
    P1 = Vertex(100, 750, 0, 255, 0)
    P2 = Vertex(150, 650, 0, 0, 255)
    ...
    P0 = Vertex(250, 650, 255, 0, 0)
    P1 = Vertex(300, 885, 0, 255, 0)
    P2 = Vertex(325, 650, 0, 0, 255)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(450, 700, 255, 0, 0)
    P1 = Vertex(500, 130, 0, 255, 0)
    ...
    P0 = Vertex(650, 650, 255, 0, 0)
    P1 = Vertex(650, 725, 0, 255, 0)
    P2 = Vertex(900, 700, 0, 0, 255)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(100, 550, 255, 0, 0)
    P1 = Vertex(100, 450, 0, 255, 0)
    P2 = Vertex(10, 500, 0, 0, 255)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(450, 550, 255, 0, 0)
    P1 = Vertex(550, 450, 0, 255, 0)
    P2 = Vertex(300, 500, 0, 0, 255)
    Poly = np.array([P0, P1, P2])
    ...
    P1 = Vertex(600, 550, 0, 128, 0)
    P2 = Vertex(500, 500, 0, 0, 128)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(800, 550, 128, 0, 0)
    P1 = Vertex(675, 650, 0, 128, 0)
    P2 = Vertex(650, 590, 0, 0, 128)
    Poly = np.array([P0, P2, P1])
    ...
    P0 = Vertex(220, 350, 128, 0, 0)
    P1 = Vertex(150, 200, 0, 128, 0)
    ...
    P0 = Vertex(200, 300, 128, 0, 0)
    P1 = Vertex(190, 250, 0, 128, 0)
    P2 = Vertex(300, 300, 0, 0, 128)
    Poly = np.array([P0, P2, P1])
    ...
    P0 = Vertex(400, 300, 128, 0, 0)
    P1 = Vertex(450, 450, 0, 128, 0)
    P2 = Vertex(500, 300, 0, 0, 128)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(600, 300, 128, 0, 0)
    P1 = Vertex(550, 100, 0, 128, 0)
    P2 = Vertex(700, 300, 0, 0, 128)
    Poly = np.array([P0, P2, P1])
    ...
    P1 = Vertex(150, 210, 0, 64, 0)
    P2 = Vertex(70, 100, 0, 0, 64)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(175, 150, 64, 0, 0)
    P1 = Vertex(250, 210, 0, 64, 0)
    P2 = Vertex(270, 10, 0, 0, 64)
    Poly = np.array([P0, P1, P2])
    ...
    P0 = Vertex(425, 200, 64, 0, 0)
    P1 = Vertex(575, 200, 0, 64, 0)
    ...
    P0 = Vertex(600, 0, 128, 128, 0)
    P1 = Vertex(700, 800, 0, 128, 128)
    P2 = Vertex(800, 0, 128, 0, 128)
    Poly = np.array([P0, P1, P2])
